...
const Navbar = () => {
    ...
    // This hook use for when user have token that thime book any services
    const {token,setToken,userDate} = useContext(AppContext)
    
    // This hook use for responsev when user sren phone, teblet, or other that time
